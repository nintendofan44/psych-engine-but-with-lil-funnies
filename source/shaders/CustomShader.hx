...
class Shader extends FlxFixedShader {
    ...
    public function new(fragCode:String, vertCode:String) {
        this.glFragmentSource = fragCode.replace("#pragma body", CustomShader.entireFuckingCustomFragmentBody).replace("#pragma header", CustomShader.entireFuckingCustomFragmentHeader).replace(" attribute ", " uniform ");
        this.glVertexSource = vertCode.replace("#pragma body", CustomShader.entireFuckingCustomVertexBody).replace("#pragma header", CustomShader.entireFuckingCustomVertexHeader);
        super();
    }
...
class CustomShader extends Shader {
    ...
    public function new(frag:String, ?vert:String, ?values:Map<String, Any>) {
        ...
        if (frag != null) {
            ...
            if(splittedFragPath[0].toLowerCase() == "psychengine") splittedFragPath[0] = "PsychEngine";
        ...
        if (vert != null) {
            ...
            if(splittedVertPath[0].toLowerCase() == "psychengine") splittedVertPath[0] = "PsychEngine";
        ...
        }".replace("#pragma body", entireFuckingCustomVertexBody).replace("#pragma header", entireFuckingCustomVertexHeader);
        ...
        }".replace("#pragma body", entireFuckingCustomFragmentBody).replace("#pragma header", entireFuckingCustomFragmentHeader).replace(" attribute ", " uniform ");
