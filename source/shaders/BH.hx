...
class BH
{
	public var shader:BHShader = new BHShader();


	public function new()
	{
		shader.iTime.value = [0];
        shader.iChannel0.input = Assets.getBitmapData(Paths.imageString("stras"));
	}
...
/**
 * Author: https://www.shadertoy.com/user/set111
 * 
 * Fnf porter/adapter for this shader: nintendofan44
 */
class BHShader extends FlxShader
{
	@:glFragmentSource('
        #pragma header
        ...
        #define _Speed 1.0  //disk rotation speed
        ...
        void main()
        {
            ...
            vec2 fragCoordRot;
            fragCoordRot.x = texcoord.x*0.985 + texcoord.y * 0.174;
            fragCoordRot.y = texcoord.y*0.985 - texcoord.x * 0.174;
