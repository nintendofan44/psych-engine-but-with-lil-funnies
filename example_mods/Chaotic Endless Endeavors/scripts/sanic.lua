...
idle_xml_name = 'sanic idle'
left_xml_name = 'sanic left'
down_xml_name = 'sanic down'
up_xml_name = 'sanic up'
right_xml_name = 'sanic right'
...
name_of_character_xml = 'sanic'
name_of_character = 'sanic'
name_of_notetype = 'sanic'
name_of_notetype2 = 'sanic and majin' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
