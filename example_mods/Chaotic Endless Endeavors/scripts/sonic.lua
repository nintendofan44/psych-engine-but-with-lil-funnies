...
idleoffsets = {'0', '90'} -- I recommend you have your idle offset at 0
leftoffsets = {'390', '38'}
downoffsets = {'14', '-4'}
upoffsets = {'40', '166'}
rightoffsets = {'180', '0'}
...
idle_xml_name = 'Beast_IDLE'
left_xml_name = 'Beast_RIGHT'
down_xml_name = 'Beast_DOWN'
up_xml_name = 'Beast_UP'
right_xml_name = 'Beast_LEFT'
...
name_of_character_xml = 'Beast'
name_of_character = 'sonic'
name_of_notetype = 'Sonic and tails'
name_of_notetype2 = 'Sonic and knuckles' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
name_of_notetype4 = 'sonic' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function opponentNoteHit(id, direction, noteType, isSustainNote)
	if noteType == name_of_notetype or noteType == name_of_notetype2 or noteType == name_of_notetype3 or noteType == name_of_notetype4 then
		doIdle = false
