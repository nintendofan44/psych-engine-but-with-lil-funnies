...
idle_xml_name = 'Eggman_Idle'
left_xml_name = 'Eggman_Left'
down_xml_name = 'Eggman_Down'
up_xml_name = 'Eggman_Up'
right_xml_name = 'Eggman_Right'
...
name_of_character_xml = 'eggman_soul'
name_of_character = 'eggmanexe'
name_of_notetype = 'eggman and bf'
name_of_notetype2 = 'eggman' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
