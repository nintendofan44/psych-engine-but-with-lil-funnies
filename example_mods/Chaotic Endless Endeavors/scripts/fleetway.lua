...
idle_xml_name = 'Fleetway Idle'
left_xml_name = 'Fleetway Left'
down_xml_name = 'Fleetway Down'
up_xml_name = 'Fleetway Up'
right_xml_name = 'Fleetway Right'
...
name_of_character_xml = 'Fleetway_Super_Sonic'
name_of_character = 'fleetway'
name_of_notetype = 'fleetway'
name_of_notetype2 = 'fleet and bf'
name_of_notetype3 = 'fleet and majin'
