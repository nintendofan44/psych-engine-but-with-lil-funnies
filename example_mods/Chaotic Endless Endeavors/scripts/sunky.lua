...
idle_xml_name = 'sunkyIDLE'
left_xml_name = 'sunkyRIGHT'
down_xml_name = 'sunkyDOWN'
up_xml_name = 'sunkyUP'
right_xml_name = 'sunkyLEFT'
...
name_of_notetype3 = 'sunky and majin' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
