...
left_xml_name = 'Tails RIGHT'
down_xml_name = 'Tails DOWN'
up_xml_name = 'Tails UP'
right_xml_name = 'Tails LEFT'
...
name_of_character_xml = 'tails'
name_of_character = 'Tails'
name_of_notetype = 'Sonic and tails'
name_of_notetype2 = 'tails' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
