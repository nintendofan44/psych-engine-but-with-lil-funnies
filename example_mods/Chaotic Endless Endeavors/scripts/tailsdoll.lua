...
idle_xml_name = 'TailsDoll IDLE'
left_xml_name = 'TailsDoll LEFT'
down_xml_name = 'TailsDoll DOWN'
up_xml_name = 'TailsDoll UP'
right_xml_name = 'TailsDoll RIGHT'
...
name_of_character_xml = 'Tails_Doll'
name_of_character = 'tailsdoll'
name_of_notetype = 'tailsdoll and majin'
name_of_notetype2 = 'tailsdoll'
